(function ($) {
	$(document).ready(function () {
		...
		function updatePrice(event) {
			...
			var html = '<input id="budget-input" type="text" name="" value="' + currentBudget + '" style="width: 70px; text-align: right;" /><i id="total_buget_pencil_icon" class="eltd-icon-linear-icon lnr lnr-pencil "></i>';
			$(self).html(html);

			//Get the input value
			$("#budget-input").focus().select().on('blur', function() {
